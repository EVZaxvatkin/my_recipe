...
import logging
from .forms import RecipeForm, LoginForm, UserRegistrationForm, CategoryForm, CookingForm
...
def get_home(request):
    ...
    return render(request, 'myrecipe/home.html', {'title': title,
                                         'num_users': num_users,
...
def get_recipes(request):
    ...
    return render(request, 'myrecipe/cooking_items.html', {'title': title, 'cooking_items': cooking_items})


def get_user_recipe_by_id(request, item_id: int):
    cooking_item = CookingItem.objects.get(pk=item_id)
    return render(request, 'myrecipe/user_detail_cooking_item.html', {'cooking_item': cooking_item})


def get_detail_recipe_by_id(request, item_id: int):
    cooking_item = CookingItem.objects.get(pk=item_id)
    title = cooking_item.recipe_id.name
    return render(request, 'myrecipe/detail_cooking_item.html', {'title': title, 'cooking_item': cooking_item})
...
def edit_recipe_by_id(request, item_id: int):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'myrecipe/form.html', {'form': recipe_form, 'title': title})
...
def edit_category_by_id(request, item_id: int):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'myrecipe/form.html', {'form': category_form, 'title': title})
    elif request.method == 'POST':
...
def get_authors(request):
    ...
    return render(request, 'myrecipe/authors.html', {'title': title, 'authors': authors})
...
def get_user_recipes(request):
    ...
    if not cooking_items:
        ...
        return redirect('/')
    return render(request, 'myrecipe/user_cooking_items.html', {'title': title, 'cooking_items': cooking_items,
...
def add_recipe(request):
    ...
    if request.method == 'GET':
        return render(request, 'myrecipe/form.html',
                      {'form': cooking_form,
                       'title': title,
